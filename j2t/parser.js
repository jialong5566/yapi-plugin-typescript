...
function parseNonLiteral(
  ...
  const definitions = getDefinitionsMemoized(getRootSchema(schema)) // TODO
  ...
  switch (type) {
    ...
    case 'NAMED_ENUM':
      return {
        comment: schema.description,
        keyName,
        standaloneName: standaloneName(schema, (keyNameFromDefinition !== undefined) && (keyNameFromDefinition !== null) && keyName, usedNames),
